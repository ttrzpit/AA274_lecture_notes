...
\input{2.non.parametric.localization}

\input{3.slam}

\input{4.further.references.tex}
%%%%
% Note: Please create a new page for each section. It makes compiling easier. You can comment out sections if you want to quickly compile only certain parts
%%%%
